...
function useB(r){if(r.skillCdB>0)return;if(r.name==='Gabriel'){waterSkill(r,true,false);return;}r.skillCdB=.9;effects.push({kind:'bubble',x:r.x,y:r.y,vx:Math.cos(r.face)*1250,vy:Math.sin(r.face)*1250,owner:r,t:1.65});msg('泡弾！');}
let effects=[];
